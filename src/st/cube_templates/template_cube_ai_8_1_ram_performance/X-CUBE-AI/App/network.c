...
#define AI_NETWORK_MODEL_SIGNATURE     "96965392242863a850749581510017d6"
...
#define AI_TOOLS_DATE_TIME   "Mon Nov 13 15:35:18 2023"
...
/* Array#26 */
AI_ARRAY_OBJ_DECLARE(
  gemm_9_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 640, AI_STATIC)
/* Array#27 */
AI_ARRAY_OBJ_DECLARE(
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 128, 640, 1, 1), AI_STRIDE_INIT(4, 4, 512, 327680, 327680),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  27, 0x0,
  AI_SHAPE_INIT(4, 640, 128, 1, 1), AI_STRIDE_INIT(4, 4, 2560, 327680, 327680),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1063456, 1, 1),
    1063456, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    gemm_0_output_array.data = AI_PTR(g_network_activations_map[0] + 2560);
    gemm_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2560);
    ...
    gemm_2_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    gemm_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    gemm_3_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    gemm_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    gemm_4_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    gemm_4_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    gemm_5_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    gemm_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    
    nl_5_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 544);
    nl_5_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 544);
    ...
    nl_6_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    nl_6_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    nl_7_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    nl_7_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    
    gemm_8_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    gemm_8_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    nl_8_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 2560);
    nl_8_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2560);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_6_bias_array.data = AI_PTR(g_network_weights_map[0] + 0);
    gemm_6_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    
    gemm_7_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_7_weights_array.data = AI_PTR(g_network_weights_map[0] + 512);
    gemm_7_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 512);
    
    gemm_7_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_7_bias_array.data = AI_PTR(g_network_weights_map[0] + 66048);
    gemm_7_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 66048);
    
    gemm_8_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_8_weights_array.data = AI_PTR(g_network_weights_map[0] + 66560);
    gemm_8_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 66560);
    
    gemm_8_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_8_bias_array.data = AI_PTR(g_network_weights_map[0] + 132096);
    gemm_8_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 132096);
    
    gemm_9_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_weights_array.data = AI_PTR(g_network_weights_map[0] + 132608);
    gemm_9_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 132608);
    
    gemm_9_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_bias_array.data = AI_PTR(g_network_weights_map[0] + 460288);
    gemm_9_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 460288);
    
    gemm_0_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 462848);
    gemm_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 462848);
    
    gemm_0_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 790528);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 790528);
    
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 791040);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 791040);
    
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 856576);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 856576);
    
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 857088);
    gemm_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 857088);
    
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 922624);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 922624);
    
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 923136);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 923136);
    
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 988672);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 988672);
    
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 989184);
    gemm_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 989184);
    
    gemm_4_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 993280);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 993280);
    
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 993312);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 993312);
    
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 997408);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 997408);
    
    gemm_6_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 997920);
    gemm_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 997920);
