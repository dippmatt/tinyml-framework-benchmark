...
def copy_build_compile(workdir: Path, repetitions: int, input_tensors, input_dtype, output_shape: tuple, cube_template: Path, cube_template_all_layers: Path):#, cube_template_ref: Path, cube_template_empty: Path):
...
def insert_layer_measurements(genModel: Path):
